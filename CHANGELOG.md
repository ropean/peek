...
- Add FreeConsole() call before exit in CLI mode
- Flush stdout/stderr before sending final newline
- This ensures clean console detachment in CMD/PowerShell
- GUI mode (double-click) remains unaffected with no console window
